package com.a99zan.retrofittest.net;

import com.a99zan.retrofittest.module.reponse.LoginBean;
import com.a99zan.retrofittest.module.reponse.LoginResponse;
import com.a99zan.retrofittest.module.reponse.MeiZi;
import com.a99zan.retrofittest.module.request.LoginRequest;
...
public interface IdeaApiService {
    ...
    @GET("login.php")
    Observable<LoginBean> getLoginInfo(@Query("name") String name, @Query("pwd") String pwd);
